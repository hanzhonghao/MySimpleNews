package cn.yumutech.mysimplenews.weather.presenter;
...
import cn.yumutech.mysimplenews.weather.model.WeatherModel;
import cn.yumutech.mysimplenews.weather.model.WeatherModelImpl;
import cn.yumutech.mysimplenews.weather.view.WeatherView;
    ...
    public void loadWeatherData() {
        ...
        WeatherModelImpl.LoadLocationListener listener = new WeatherModelImpl.LoadLocationListener() {
            ...
            public void onFailure(String msg, Exception e) {
                ...
                mWeatherView.setCity("成都");
                mWeatherModel.loadWeatherData("成都", WeatherPresenterImpl.this);
            }
        };
        //获取定位信息
